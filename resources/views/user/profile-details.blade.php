            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    ...
                    <div id="panel_edit_account" class="tab-pane fade">
                        <form action="#" role="form" id="form-edit-user-details" method="post"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <label class="radio-inline">
                                                            <input type="radio" class="red" value="1" name="sex"
                                                                   id="female" checked=""> <!-- Bug here -->
                                                            Female
                                                        </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" class="red" value="0" name="sex"
                                                                   id="male" checked=""> <!-- Bug here -->
                                                            Male
                                                        </label>
                                                    </div>
                                                </div>
                            ...
                            <div class="user-left">
                                <div class="col-sm-6">
                                    <table class="table table-condensed table-hover" id="login_methods_details">
                                        ...
                                        <tr>
                                            <td class="column-left"><i class="fa fa-cloud fa-2x"></i> Current Email:
                                            </td>
